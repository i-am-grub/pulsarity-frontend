...
export const pulsarity = ($root.pulsarity = (() => {
  ...
  pulsarity.db = (function () {
    ...
    db.Attribute = (function () {
       ...
       */
      Attribute.decode = function decode(
        reader,
        length,
        _end,
        _depth,
        ...
        let end = length === undefined ? reader.len : reader.pos + length,
          message = _target || new $root.pulsarity.db.Attribute(),
          value;
      ...
      Attribute.fromObject = function fromObject(object, _depth) {
        if (object instanceof $root.pulsarity.db.Attribute) return object;
        if (_depth === undefined) _depth = 0;
    ...
    db.Pilot = (function () {
       ...
       * @returns {$protobuf.Writer} Writer
       */
      Pilot.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.id != null && Object.hasOwnProperty.call(message, "id"))
          writer.uint32(/* id 1, wireType 0 =*/ 8).int32(message.id);
        if (
          message.displayCallsign != null &&
          Object.hasOwnProperty.call(message, "displayCallsign")
        )
          writer
            .uint32(/* id 2, wireType 2 =*/ 18)
            .string(message.displayCallsign);
        if (
        ...
        if (message.attributes != null && message.attributes.length)
          for (let i = 0; i < message.attributes.length; ++i)
            $root.pulsarity.db.Attribute.encode(
      ...
      Pilot.decode = function decode(reader, length, _end, _depth, _target) {
        ...
        if (_depth > $Reader.recursionLimit) throw Error("max depth exceeded");
        let end = length === undefined ? reader.len : reader.pos + length,
          message = _target || new $root.pulsarity.db.Pilot(),
          value;
        while (reader.pos < end) {
          let start = reader.pos;
          let tag = reader.tag();
          ...
          switch ((tag >>>= 3)) {
            case 1: {
              if (wireType !== 0) break;
              if ((value = reader.int32())) message.id = value;
            ...
            case 2: {
              ...
              else delete message.displayCallsign;
              continue;
            }
            case 3: {
              if (wireType !== 2) break;
              if ((value = reader.string()).length) message.displayName = value;
              else delete message.displayName;
              continue;
            }
            case 4: {
              if (wireType !== 2) break;
              ...
              message.attributes.push(
                $root.pulsarity.db.Attribute.decode(
                  reader,
                  reader.uint32(),
                  undefined,
                  _depth + 1,
      ...
      Pilot.verify = function verify(message, _depth) {
        ...
        if (
          message.displayCallsign != null &&
          message.hasOwnProperty("displayCallsign")
        )
        ...
        if (
          ...
          for (let i = 0; i < message.attributes.length; ++i) {
            let error = $root.pulsarity.db.Attribute.verify(
              message.attributes[i],
              _depth + 1,
            );
      ...
      Pilot.fromObject = function fromObject(object, _depth) {
        if (object instanceof $root.pulsarity.db.Pilot) return object;
        if (_depth === undefined) _depth = 0;
        if (_depth > $util.recursionLimit) throw Error("max depth exceeded");
        let message = new $root.pulsarity.db.Pilot();
        if (object.id != null)
          if (Number(object.id) !== 0) message.id = object.id | 0;
        if (object.displayCallsign != null)
          if (
            typeof object.displayCallsign !== "string" ||
            object.displayCallsign.length
          )
            message.displayCallsign = String(object.displayCallsign);
        if (object.displayName != null)
          if (
            typeof object.displayName !== "string" ||
            object.displayName.length
          )
        ...
        if (object.attributes) {
          ...
          for (let i = 0; i < object.attributes.length; ++i) {
            if (typeof object.attributes[i] !== "object")
              throw TypeError(
                ".pulsarity.db.Pilot.attributes: object expected",
              );
            message.attributes[i] = $root.pulsarity.db.Attribute.fromObject(
              object.attributes[i],
              _depth + 1,
            );
          }
       ...
       * @returns {Object.<string,*>} Plain object
       */
      Pilot.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        ...
        if (message.attributes && message.attributes.length) {
          ...
          for (let j = 0; j < message.attributes.length; ++j)
            object.attributes[j] = $root.pulsarity.db.Attribute.toObject(
    ...
    db.Pilots = (function () {
      ...
      Pilots.decode = function decode(reader, length, _end, _depth, _target) {
        ...
        if (_depth > $Reader.recursionLimit) throw Error("max depth exceeded");
        let end = length === undefined ? reader.len : reader.pos + length,
          message = _target || new $root.pulsarity.db.Pilots();
        while (reader.pos < end) {
          let start = reader.pos;
          let tag = reader.tag();
          if (tag === _end) {
          ...
          switch ((tag >>>= 3)) {
            case 1: {
              ...
              if (!(message.pilots && message.pilots.length))
                message.pilots = [];
              message.pilots.push(
                $root.pulsarity.db.Pilot.decode(
                  reader,
                  reader.uint32(),
                  undefined,
                  _depth + 1,
      ...
      Pilots.verify = function verify(message, _depth) {
        ...
        if (message.pilots != null && message.hasOwnProperty("pilots")) {
          if (!Array.isArray(message.pilots)) return "pilots: array expected";
          for (let i = 0; i < message.pilots.length; ++i) {
            let error = $root.pulsarity.db.Pilot.verify(
              message.pilots[i],
              _depth + 1,
            );
            if (error) return "pilots." + error;
          }
        }
        return null;
      };
      ...
      Pilots.fromObject = function fromObject(object, _depth) {
        if (object instanceof $root.pulsarity.db.Pilots) return object;
        if (_depth === undefined) _depth = 0;
        if (_depth > $util.recursionLimit) throw Error("max depth exceeded");
        ...
        if (object.pilots) {
          ...
          for (let i = 0; i < object.pilots.length; ++i) {
            ...
            message.pilots[i] = $root.pulsarity.db.Pilot.fromObject(
              object.pilots[i],
              _depth + 1,
            );
          }
       ...
       * @returns {Object.<string,*>} Plain object
       */
      Pilots.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        if (options.arrays || options.defaults) object.pilots = [];
        if (message.pilots && message.pilots.length) {
          object.pilots = Array(message.pilots.length);
          for (let j = 0; j < message.pilots.length; ++j)
            object.pilots[j] = $root.pulsarity.db.Pilot.toObject(
              message.pilots[j],
              options,
            );
        }
    ...
    db.RaceEvent = (function () {
       ...
       * @returns {$protobuf.Writer} Writer
       */
      RaceEvent.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.id != null && Object.hasOwnProperty.call(message, "id"))
          writer.uint32(/* id 1, wireType 0 =*/ 8).int32(message.id);
        if (message.name != null && Object.hasOwnProperty.call(message, "name"))
       ...
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      RaceEvent.decode = function decode(
        reader,
        length,
        _end,
        _depth,
        ...
        if (_depth > $Reader.recursionLimit) throw Error("max depth exceeded");
        let end = length === undefined ? reader.len : reader.pos + length,
          message = _target || new $root.pulsarity.db.RaceEvent(),
          value;
        while (reader.pos < end) {
          let start = reader.pos;
          let tag = reader.tag();
          ...
          switch ((tag >>>= 3)) {
            ...
            case 3: {
              if (wireType !== 2) break;
              message.date = $root.google.protobuf.Timestamp.decode(
                reader,
                reader.uint32(),
                undefined,
                _depth + 1,
      ...
      RaceEvent.fromObject = function fromObject(object, _depth) {
        if (object instanceof $root.pulsarity.db.RaceEvent) return object;
        if (_depth === undefined) _depth = 0;
        if (_depth > $util.recursionLimit) throw Error("max depth exceeded");
        ...
        if (object.date != null) {
          ...
          message.date = $root.google.protobuf.Timestamp.fromObject(
            object.date,
            _depth + 1,
          );
        }
        if (object.attributes) {
          if (!Array.isArray(object.attributes))
            throw TypeError(
              ".pulsarity.db.RaceEvent.attributes: array expected",
            );
          message.attributes = Array(object.attributes.length);
          for (let i = 0; i < object.attributes.length; ++i) {
            if (typeof object.attributes[i] !== "object")
              throw TypeError(
                ".pulsarity.db.RaceEvent.attributes: object expected",
              );
            message.attributes[i] = $root.pulsarity.db.Attribute.fromObject(
              object.attributes[i],
              _depth + 1,
       ...
       * @returns {Object.<string,*>} Plain object
       */
      RaceEvent.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        if (options.arrays || options.defaults) object.attributes = [];
        if (options.defaults) {
        ...
        if (message.name != null && message.hasOwnProperty("name"))
          object.name = message.name;
        if (message.date != null && message.hasOwnProperty("date"))
          object.date = $root.google.protobuf.Timestamp.toObject(
            message.date,
            options,
          );
        if (message.attributes && message.attributes.length) {
    ...
    db.RaceEvents = (function () {
       ...
       * @returns {$protobuf.Writer} Writer
       */
      RaceEvents.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.events != null && message.events.length)
          for (let i = 0; i < message.events.length; ++i)
            $root.pulsarity.db.RaceEvent.encode(
              message.events[i],
              writer.uint32(/* id 1, wireType 2 =*/ 10).fork(),
            ).ldelim();
        if (
       ...
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      RaceEvents.decode = function decode(
        reader,
        length,
        _end,
        _depth,
        ...
        if (_depth > $Reader.recursionLimit) throw Error("max depth exceeded");
        let end = length === undefined ? reader.len : reader.pos + length,
          message = _target || new $root.pulsarity.db.RaceEvents();
        while (reader.pos < end) {
          let start = reader.pos;
          let tag = reader.tag();
          if (tag === _end) {
          ...
          switch ((tag >>>= 3)) {
            case 1: {
              ...
              if (!(message.events && message.events.length))
                message.events = [];
              message.events.push(
                $root.pulsarity.db.RaceEvent.decode(
                  reader,
                  reader.uint32(),
                  undefined,
                  _depth + 1,
      ...
      RaceEvents.verify = function verify(message, _depth) {
        ...
        if (message.events != null && message.hasOwnProperty("events")) {
          ...
          for (let i = 0; i < message.events.length; ++i) {
            let error = $root.pulsarity.db.RaceEvent.verify(
              message.events[i],
              _depth + 1,
            );
      ...
      RaceEvents.fromObject = function fromObject(object, _depth) {
        if (object instanceof $root.pulsarity.db.RaceEvents) return object;
        if (_depth === undefined) _depth = 0;
        if (_depth > $util.recursionLimit) throw Error("max depth exceeded");
        ...
        if (object.events) {
          ...
          for (let i = 0; i < object.events.length; ++i) {
            if (typeof object.events[i] !== "object")
              throw TypeError(
                ".pulsarity.db.RaceEvents.events: object expected",
              );
            message.events[i] = $root.pulsarity.db.RaceEvent.fromObject(
              object.events[i],
              _depth + 1,
            );
          }
       ...
       * @returns {Object.<string,*>} Plain object
       */
      RaceEvents.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        ...
        if (message.events && message.events.length) {
          ...
          for (let j = 0; j < message.events.length; ++j)
            object.events[j] = $root.pulsarity.db.RaceEvent.toObject(
              message.events[j],
              options,
            );
        }
    ...
    db.RaceClass = (function () {
       ...
       * @returns {$protobuf.Writer} Writer
       */
      RaceClass.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.id != null && Object.hasOwnProperty.call(message, "id"))
          writer.uint32(/* id 1, wireType 0 =*/ 8).int32(message.id);
        if (message.name != null && Object.hasOwnProperty.call(message, "name"))
       ...
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      RaceClass.decode = function decode(
        reader,
        length,
        _end,
        _depth,
        ...
        if (_depth > $Reader.recursionLimit) throw Error("max depth exceeded");
        let end = length === undefined ? reader.len : reader.pos + length,
          message = _target || new $root.pulsarity.db.RaceClass(),
          value;
        while (reader.pos < end) {
          let start = reader.pos;
          let tag = reader.tag();
      ...
      RaceClass.fromObject = function fromObject(object, _depth) {
        if (object instanceof $root.pulsarity.db.RaceClass) return object;
        if (_depth === undefined) _depth = 0;
        if (_depth > $util.recursionLimit) throw Error("max depth exceeded");
        ...
        if (object.attributes) {
          if (!Array.isArray(object.attributes))
            throw TypeError(
              ".pulsarity.db.RaceClass.attributes: array expected",
            );
          message.attributes = Array(object.attributes.length);
          for (let i = 0; i < object.attributes.length; ++i) {
            if (typeof object.attributes[i] !== "object")
              throw TypeError(
                ".pulsarity.db.RaceClass.attributes: object expected",
              );
            message.attributes[i] = $root.pulsarity.db.Attribute.fromObject(
              object.attributes[i],
              _depth + 1,
       ...
       * @returns {Object.<string,*>} Plain object
       */
      RaceClass.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        if (options.arrays || options.defaults) object.attributes = [];
        if (options.defaults) {
    ...
    db.RaceClasses = (function () {
       ...
       * @returns {$protobuf.Writer} Writer
       */
      RaceClasses.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.raceclasses != null && message.raceclasses.length)
          for (let i = 0; i < message.raceclasses.length; ++i)
            $root.pulsarity.db.RaceClass.encode(
              message.raceclasses[i],
              writer.uint32(/* id 1, wireType 2 =*/ 10).fork(),
            ).ldelim();
        if (
          message.$unknowns != null &&
       ...
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      RaceClasses.decode = function decode(
        reader,
        length,
        _end,
        _depth,
        ...
        if (_depth > $Reader.recursionLimit) throw Error("max depth exceeded");
        let end = length === undefined ? reader.len : reader.pos + length,
          message = _target || new $root.pulsarity.db.RaceClasses();
        while (reader.pos < end) {
          let start = reader.pos;
          let tag = reader.tag();
          if (tag === _end) {
          ...
          switch ((tag >>>= 3)) {
            case 1: {
              ...
              if (!(message.raceclasses && message.raceclasses.length))
                message.raceclasses = [];
              message.raceclasses.push(
                $root.pulsarity.db.RaceClass.decode(
                  reader,
                  reader.uint32(),
                  undefined,
                  _depth + 1,
      ...
      RaceClasses.verify = function verify(message, _depth) {
        ...
        if (_depth > $util.recursionLimit) return "max depth exceeded";
        if (
          message.raceclasses != null &&
          message.hasOwnProperty("raceclasses")
        ) {
          if (!Array.isArray(message.raceclasses))
            return "raceclasses: array expected";
          for (let i = 0; i < message.raceclasses.length; ++i) {
            let error = $root.pulsarity.db.RaceClass.verify(
              message.raceclasses[i],
              _depth + 1,
            );
            if (error) return "raceclasses." + error;
          }
        }
        return null;
      };
      ...
      RaceClasses.fromObject = function fromObject(object, _depth) {
        if (object instanceof $root.pulsarity.db.RaceClasses) return object;
        if (_depth === undefined) _depth = 0;
        if (_depth > $util.recursionLimit) throw Error("max depth exceeded");
        ...
        if (object.raceclasses) {
          if (!Array.isArray(object.raceclasses))
            throw TypeError(
              ".pulsarity.db.RaceClasses.raceclasses: array expected",
            );
          ...
          for (let i = 0; i < object.raceclasses.length; ++i) {
            if (typeof object.raceclasses[i] !== "object")
              throw TypeError(
                ".pulsarity.db.RaceClasses.raceclasses: object expected",
              );
            message.raceclasses[i] = $root.pulsarity.db.RaceClass.fromObject(
              object.raceclasses[i],
              _depth + 1,
            );
          }
        }
       ...
       * @returns {Object.<string,*>} Plain object
       */
      RaceClasses.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        if (options.arrays || options.defaults) object.raceclasses = [];
        if (message.raceclasses && message.raceclasses.length) {
          object.raceclasses = Array(message.raceclasses.length);
          for (let j = 0; j < message.raceclasses.length; ++j)
            object.raceclasses[j] = $root.pulsarity.db.RaceClass.toObject(
              message.raceclasses[j],
              options,
            );
        }
        return object;
    ...
    db.Round = (function () {
      ...
      Round.encode = function encode(message, writer) {
        ...
        if (message.id != null && Object.hasOwnProperty.call(message, "id"))
          writer.uint32(/* id 1, wireType 0 =*/ 8).int32(message.id);
        if (
          message.roundNum != null &&
          Object.hasOwnProperty.call(message, "roundNum")
        )
      ...
      Round.decode = function decode(reader, length, _end, _depth, _target) {
        ...
        if (_depth > $Reader.recursionLimit) throw Error("max depth exceeded");
        let end = length === undefined ? reader.len : reader.pos + length,
          message = _target || new $root.pulsarity.db.Round(),
          value;
        while (reader.pos < end) {
          let start = reader.pos;
          let tag = reader.tag();
          ...
          switch ((tag >>>= 3)) {
            ...
            case 2: {
              if (wireType !== 0) break;
              if ((value = reader.int32())) message.roundNum = value;
              else delete message.roundNum;
              continue;
            }
            case 3: {
              if (wireType !== 2) break;
      ...
      Round.fromObject = function fromObject(object, _depth) {
        if (object instanceof $root.pulsarity.db.Round) return object;
        if (_depth === undefined) _depth = 0;
        if (_depth > $util.recursionLimit) throw Error("max depth exceeded");
        ...
        if (object.attributes) {
          ...
          for (let i = 0; i < object.attributes.length; ++i) {
            if (typeof object.attributes[i] !== "object")
              throw TypeError(
                ".pulsarity.db.Round.attributes: object expected",
              );
            message.attributes[i] = $root.pulsarity.db.Attribute.fromObject(
              object.attributes[i],
              _depth + 1,
    ...
    db.Rounds = (function () {
      ...
      Rounds.decode = function decode(reader, length, _end, _depth, _target) {
        ...
        if (_depth > $Reader.recursionLimit) throw Error("max depth exceeded");
        let end = length === undefined ? reader.len : reader.pos + length,
          message = _target || new $root.pulsarity.db.Rounds();
        while (reader.pos < end) {
          let start = reader.pos;
          let tag = reader.tag();
          if (tag === _end) {
          ...
          switch ((tag >>>= 3)) {
            case 1: {
              ...
              if (!(message.rounds && message.rounds.length))
                message.rounds = [];
              message.rounds.push(
                $root.pulsarity.db.Round.decode(
                  reader,
                  reader.uint32(),
                  undefined,
                  _depth + 1,
      ...
      Rounds.verify = function verify(message, _depth) {
        ...
        if (message.rounds != null && message.hasOwnProperty("rounds")) {
          ...
          for (let i = 0; i < message.rounds.length; ++i) {
            let error = $root.pulsarity.db.Round.verify(
              message.rounds[i],
              _depth + 1,
            );
      ...
      Rounds.fromObject = function fromObject(object, _depth) {
        if (object instanceof $root.pulsarity.db.Rounds) return object;
        if (_depth === undefined) _depth = 0;
        if (_depth > $util.recursionLimit) throw Error("max depth exceeded");
        ...
        if (object.rounds) {
          ...
          for (let i = 0; i < object.rounds.length; ++i) {
            ...
            message.rounds[i] = $root.pulsarity.db.Round.fromObject(
              object.rounds[i],
              _depth + 1,
            );
          }
       ...
       * @returns {Object.<string,*>} Plain object
       */
      Rounds.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        ...
        if (message.rounds && message.rounds.length) {
          ...
          for (let j = 0; j < message.rounds.length; ++j)
            object.rounds[j] = $root.pulsarity.db.Round.toObject(
              message.rounds[j],
              options,
            );
        }
    ...
    db.Heat = (function () {
      ...
      Heat.encode = function encode(message, writer) {
        ...
        if (message.id != null && Object.hasOwnProperty.call(message, "id"))
          writer.uint32(/* id 1, wireType 0 =*/ 8).int32(message.id);
        if (
          message.heatNum != null &&
          Object.hasOwnProperty.call(message, "heatNum")
        )
      ...
      Heat.decode = function decode(reader, length, _end, _depth, _target) {
        ...
        if (_depth > $Reader.recursionLimit) throw Error("max depth exceeded");
        let end = length === undefined ? reader.len : reader.pos + length,
          message = _target || new $root.pulsarity.db.Heat(),
          value;
        while (reader.pos < end) {
          let start = reader.pos;
          let tag = reader.tag();
          ...
          switch ((tag >>>= 3)) {
            ...
            case 2: {
              if (wireType !== 0) break;
              if ((value = reader.int32())) message.heatNum = value;
              else delete message.heatNum;
              continue;
            }
            case 3: {
              if (wireType !== 2) break;
      ...
      Heat.fromObject = function fromObject(object, _depth) {
        if (object instanceof $root.pulsarity.db.Heat) return object;
        if (_depth === undefined) _depth = 0;
        if (_depth > $util.recursionLimit) throw Error("max depth exceeded");
    ...
    db.Heats = (function () {
      ...
      Heats.decode = function decode(reader, length, _end, _depth, _target) {
        ...
        if (_depth > $Reader.recursionLimit) throw Error("max depth exceeded");
        let end = length === undefined ? reader.len : reader.pos + length,
          message = _target || new $root.pulsarity.db.Heats();
        while (reader.pos < end) {
          let start = reader.pos;
          let tag = reader.tag();
          if (tag === _end) {
          ...
          switch ((tag >>>= 3)) {
            case 1: {
              if (wireType !== 2) break;
              if (!(message.heats && message.heats.length)) message.heats = [];
              message.heats.push(
                $root.pulsarity.db.Heat.decode(
                  reader,
                  reader.uint32(),
                  undefined,
                  _depth + 1,
      ...
      Heats.verify = function verify(message, _depth) {
        ...
        if (message.heats != null && message.hasOwnProperty("heats")) {
          if (!Array.isArray(message.heats)) return "heats: array expected";
          for (let i = 0; i < message.heats.length; ++i) {
            let error = $root.pulsarity.db.Heat.verify(
              message.heats[i],
              _depth + 1,
            );
            if (error) return "heats." + error;
          }
        }
        return null;
      };
      ...
      Heats.fromObject = function fromObject(object, _depth) {
        if (object instanceof $root.pulsarity.db.Heats) return object;
        if (_depth === undefined) _depth = 0;
        if (_depth > $util.recursionLimit) throw Error("max depth exceeded");
        ...
        if (object.heats) {
          ...
          for (let i = 0; i < object.heats.length; ++i) {
            ...
            message.heats[i] = $root.pulsarity.db.Heat.fromObject(
              object.heats[i],
              _depth + 1,
            );
          }
       ...
       * @returns {Object.<string,*>} Plain object
       */
      Heats.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        if (options.arrays || options.defaults) object.heats = [];
        if (message.heats && message.heats.length) {
          object.heats = Array(message.heats.length);
          for (let j = 0; j < message.heats.length; ++j)
            object.heats[j] = $root.pulsarity.db.Heat.toObject(
              message.heats[j],
              options,
            );
        }
    ...
    db.SignalRecord = (function () {
       ...
       * @returns {$protobuf.Writer} Writer
       */
      SignalRecord.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (
          message.timedelta != null &&
          Object.hasOwnProperty.call(message, "timedelta")
        )
       ...
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      SignalRecord.decode = function decode(
        reader,
        length,
        _end,
        _depth,
        ...
        if (_depth > $Reader.recursionLimit) throw Error("max depth exceeded");
        let end = length === undefined ? reader.len : reader.pos + length,
          message = _target || new $root.pulsarity.db.SignalRecord(),
          value;
        while (reader.pos < end) {
          let start = reader.pos;
          let tag = reader.tag();
          ...
          switch ((tag >>>= 3)) {
            case 1: {
              if (wireType !== 5) break;
              if ((value = reader.float()) !== 0) message.timedelta = value;
              else delete message.timedelta;
              continue;
            }
            case 2: {
              if (wireType !== 5) break;
      ...
      SignalRecord.fromObject = function fromObject(object, _depth) {
        if (object instanceof $root.pulsarity.db.SignalRecord) return object;
        if (_depth === undefined) _depth = 0;
        if (_depth > $util.recursionLimit) throw Error("max depth exceeded");
        ...
        if (object.value != null)
          if (Number(object.value) !== 0) message.value = Number(object.value);
        return message;
      };
       ...
       * @returns {Object.<string,*>} Plain object
       */
      SignalRecord.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        if (options.defaults) {
          object.timedelta = 0;
        ...
        if (message.timedelta != null && message.hasOwnProperty("timedelta"))
          object.timedelta =
            options.json && !isFinite(message.timedelta)
              ? String(message.timedelta)
              : message.timedelta;
        if (message.value != null && message.hasOwnProperty("value"))
          object.value =
    ...
    db.SignalHistory = (function () {
       ...
       * @returns {$protobuf.Writer} Writer
       */
      SignalHistory.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.records != null && message.records.length)
          for (let i = 0; i < message.records.length; ++i)
            $root.pulsarity.db.SignalRecord.encode(
              message.records[i],
              writer.uint32(/* id 1, wireType 2 =*/ 10).fork(),
            ).ldelim();
        if (
       ...
       * @returns {$protobuf.Writer} Writer
       */
      SignalHistory.encodeDelimited = function encodeDelimited(
        message,
        writer,
      ) {
        return this.encode(message, writer).ldelim();
       ...
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      SignalHistory.decode = function decode(
        reader,
        length,
        _end,
        _depth,
        ...
        if (_depth > $Reader.recursionLimit) throw Error("max depth exceeded");
        let end = length === undefined ? reader.len : reader.pos + length,
          message = _target || new $root.pulsarity.db.SignalHistory();
        while (reader.pos < end) {
          let start = reader.pos;
          let tag = reader.tag();
          if (tag === _end) {
          ...
          switch ((tag >>>= 3)) {
            case 1: {
              ...
              message.records.push(
                $root.pulsarity.db.SignalRecord.decode(
                  reader,
                  reader.uint32(),
                  undefined,
                  _depth + 1,
      ...
      SignalHistory.verify = function verify(message, _depth) {
        ...
        if (message.records != null && message.hasOwnProperty("records")) {
          ...
          for (let i = 0; i < message.records.length; ++i) {
            let error = $root.pulsarity.db.SignalRecord.verify(
              message.records[i],
              _depth + 1,
            );
      ...
      SignalHistory.fromObject = function fromObject(object, _depth) {
        if (object instanceof $root.pulsarity.db.SignalHistory) return object;
        if (_depth === undefined) _depth = 0;
        if (_depth > $util.recursionLimit) throw Error("max depth exceeded");
        ...
        if (object.records) {
          if (!Array.isArray(object.records))
            throw TypeError(
              ".pulsarity.db.SignalHistory.records: array expected",
            );
          message.records = Array(object.records.length);
          for (let i = 0; i < object.records.length; ++i) {
            if (typeof object.records[i] !== "object")
              throw TypeError(
                ".pulsarity.db.SignalHistory.records: object expected",
              );
            message.records[i] = $root.pulsarity.db.SignalRecord.fromObject(
              object.records[i],
              _depth + 1,
            );
          }
       ...
       * @returns {Object.<string,*>} Plain object
       */
      SignalHistory.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        ...
        if (message.records && message.records.length) {
          ...
          for (let j = 0; j < message.records.length; ++j)
            object.records[j] = $root.pulsarity.db.SignalRecord.toObject(
              message.records[j],
              options,
            );
        }
  ...
  pulsarity.http = (function () {
    ...
    http.StatusResponse = (function () {
       ...
       * @returns {$protobuf.Writer} Writer
       */
      StatusResponse.encodeDelimited = function encodeDelimited(
        message,
        writer,
      ) {
        return this.encode(message, writer).ldelim();
       ...
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      StatusResponse.decode = function decode(
        reader,
        length,
        _end,
        _depth,
        ...
        if (_depth > $Reader.recursionLimit) throw Error("max depth exceeded");
        let end = length === undefined ? reader.len : reader.pos + length,
          message = _target || new $root.pulsarity.http.StatusResponse(),
          value;
        while (reader.pos < end) {
          let start = reader.pos;
          let tag = reader.tag();
          ...
          switch ((tag >>>= 3)) {
            case 1: {
              if (wireType !== 0) break;
              if ((value = reader.bool())) message.status = value;
      ...
      StatusResponse.fromObject = function fromObject(object, _depth) {
        ...
        if (object.status != null)
          if (object.status) message.status = Boolean(object.status);
        return message;
      };
      ...
      StatusResponse.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        if (options.defaults) object.status = false;
        if (message.status != null && message.hasOwnProperty("status"))
    ...
    http.LoginRequest = (function () {
       ...
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      LoginRequest.decode = function decode(
        reader,
        length,
        _end,
        _depth,
        ...
        if (_depth > $Reader.recursionLimit) throw Error("max depth exceeded");
        let end = length === undefined ? reader.len : reader.pos + length,
          message = _target || new $root.pulsarity.http.LoginRequest(),
          value;
        while (reader.pos < end) {
          let start = reader.pos;
          let tag = reader.tag();
          ...
          switch ((tag >>>= 3)) {
            case 1: {
              if (wireType !== 2) break;
              if ((value = reader.string()).length) message.username = value;
              else delete message.username;
              continue;
            }
            case 2: {
              if (wireType !== 2) break;
              if ((value = reader.string()).length) message.password = value;
              else delete message.password;
              continue;
            }
          }
          reader.skipType(wireType, _depth, tag);
      ...
      LoginRequest.fromObject = function fromObject(object, _depth) {
        if (object instanceof $root.pulsarity.http.LoginRequest) return object;
        if (_depth === undefined) _depth = 0;
        if (_depth > $util.recursionLimit) throw Error("max depth exceeded");
    ...
    http.LoginResponse = (function () {
      ...
      LoginResponse.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (
          message.passwordResetRequired != null &&
          Object.hasOwnProperty.call(message, "passwordResetRequired")
        )
          writer
            .uint32(/* id 1, wireType 0 =*/ 8)
            .bool(message.passwordResetRequired);
        if (
          message.$unknowns != null &&
          Object.hasOwnProperty.call(message, "$unknowns")
        )
       ...
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      LoginResponse.decode = function decode(
        reader,
        length,
        _end,
        _depth,
        ...
        if (_depth > $Reader.recursionLimit) throw Error("max depth exceeded");
        let end = length === undefined ? reader.len : reader.pos + length,
          message = _target || new $root.pulsarity.http.LoginResponse(),
          value;
        while (reader.pos < end) {
          let start = reader.pos;
          let tag = reader.tag();
          ...
          switch ((tag >>>= 3)) {
            case 1: {
              ...
              else delete message.passwordResetRequired;
              continue;
            }
          }
          reader.skipType(wireType, _depth, tag);
      ...
      LoginResponse.verify = function verify(message, _depth) {
        ...
        if (
          message.passwordResetRequired != null &&
          message.hasOwnProperty("passwordResetRequired")
        )
      ...
      LoginResponse.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        if (options.defaults) object.passwordResetRequired = false;
        if (
          message.passwordResetRequired != null &&
          message.hasOwnProperty("passwordResetRequired")
        )
    ...
    http.ResetPasswordRequest = (function () {
       ...
       * @returns {$protobuf.Writer} Writer
       */
      ResetPasswordRequest.encodeDelimited = function encodeDelimited(
        message,
        writer,
      ) {
        return this.encode(message, writer).ldelim();
       ...
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      ResetPasswordRequest.decode = function decode(
        reader,
        length,
        _end,
        _depth,
        ...
        if (_depth > $Reader.recursionLimit) throw Error("max depth exceeded");
        let end = length === undefined ? reader.len : reader.pos + length,
          message = _target || new $root.pulsarity.http.ResetPasswordRequest(),
          value;
        while (reader.pos < end) {
          let start = reader.pos;
          let tag = reader.tag();
          ...
          switch ((tag >>>= 3)) {
            case 1: {
              if (wireType !== 2) break;
              if ((value = reader.string()).length) message.oldPassword = value;
              else delete message.oldPassword;
              continue;
            }
            case 2: {
              if (wireType !== 2) break;
              if ((value = reader.string()).length) message.newPassword = value;
              else delete message.newPassword;
              continue;
            }
          }
          reader.skipType(wireType, _depth, tag);
      ...
      ResetPasswordRequest.fromObject = function fromObject(object, _depth) {
        ...
        if (object.oldPassword != null)
          if (
            typeof object.oldPassword !== "string" ||
            object.oldPassword.length
          )
            message.oldPassword = String(object.oldPassword);
        if (object.newPassword != null)
          if (
            typeof object.newPassword !== "string" ||
            object.newPassword.length
          )
  ...
  pulsarity.ws = (function () {
    ...
    ws.PilotAddData = (function () {
       ...
       * @returns {$protobuf.Writer} Writer
       */
      PilotAddData.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (
          message.pilotId != null &&
          Object.hasOwnProperty.call(message, "pilotId")
        )
       ...
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      PilotAddData.decode = function decode(
        reader,
        length,
        _end,
        _depth,
        ...
        if (_depth > $Reader.recursionLimit) throw Error("max depth exceeded");
        let end = length === undefined ? reader.len : reader.pos + length,
          message = _target || new $root.pulsarity.ws.PilotAddData(),
          value;
        while (reader.pos < end) {
          let start = reader.pos;
          let tag = reader.tag();
          ...
          switch ((tag >>>= 3)) {
            case 1: {
              if (wireType !== 0) break;
              if ((value = reader.int32())) message.pilotId = value;
              else delete message.pilotId;
              continue;
            }
          }
          reader.skipType(wireType, _depth, tag);
      ...
      PilotAddData.fromObject = function fromObject(object, _depth) {
        if (object instanceof $root.pulsarity.ws.PilotAddData) return object;
        if (_depth === undefined) _depth = 0;
        if (_depth > $util.recursionLimit) throw Error("max depth exceeded");
       ...
       * @returns {Object.<string,*>} Plain object
       */
      PilotAddData.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        if (options.defaults) object.pilotId = 0;
        if (message.pilotId != null && message.hasOwnProperty("pilotId"))
    ...
    ws.PilotAlterData = (function () {
       ...
       * @returns {$protobuf.Writer} Writer
       */
      PilotAlterData.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (
          message.pilotId != null &&
          Object.hasOwnProperty.call(message, "pilotId")
       ...
       * @returns {$protobuf.Writer} Writer
       */
      PilotAlterData.encodeDelimited = function encodeDelimited(
        message,
        writer,
      ) {
        return this.encode(message, writer).ldelim();
       ...
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      PilotAlterData.decode = function decode(
        reader,
        length,
        _end,
        _depth,
        ...
        if (_depth > $Reader.recursionLimit) throw Error("max depth exceeded");
        let end = length === undefined ? reader.len : reader.pos + length,
          message = _target || new $root.pulsarity.ws.PilotAlterData(),
          value;
        while (reader.pos < end) {
          let start = reader.pos;
          let tag = reader.tag();
      ...
      PilotAlterData.fromObject = function fromObject(object, _depth) {
        if (object instanceof $root.pulsarity.ws.PilotAlterData) return object;
        if (_depth === undefined) _depth = 0;
        if (_depth > $util.recursionLimit) throw Error("max depth exceeded");
       ...
       * @returns {Object.<string,*>} Plain object
       */
      PilotAlterData.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        if (options.defaults) object.pilotId = 0;
        if (message.pilotId != null && message.hasOwnProperty("pilotId"))
    ...
    ws.PilotDeleteData = (function () {
       ...
       * @returns {$protobuf.Writer} Writer
       */
      PilotDeleteData.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (
          message.pilotId != null &&
          Object.hasOwnProperty.call(message, "pilotId")
       ...
       * @returns {$protobuf.Writer} Writer
       */
      PilotDeleteData.encodeDelimited = function encodeDelimited(
        message,
        writer,
      ) {
        return this.encode(message, writer).ldelim();
       ...
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      PilotDeleteData.decode = function decode(
        reader,
        length,
        _end,
        _depth,
        ...
        if (_depth > $Reader.recursionLimit) throw Error("max depth exceeded");
        let end = length === undefined ? reader.len : reader.pos + length,
          message = _target || new $root.pulsarity.ws.PilotDeleteData(),
          value;
        while (reader.pos < end) {
          let start = reader.pos;
          let tag = reader.tag();
      ...
      PilotDeleteData.fromObject = function fromObject(object, _depth) {
        if (object instanceof $root.pulsarity.ws.PilotDeleteData) return object;
        if (_depth === undefined) _depth = 0;
        if (_depth > $util.recursionLimit) throw Error("max depth exceeded");
       ...
       * @returns {Object.<string,*>} Plain object
       */
      PilotDeleteData.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        if (options.defaults) object.pilotId = 0;
        if (message.pilotId != null && message.hasOwnProperty("pilotId"))
    ...
    ws.WebsocketEvent = (function () {
      ...
      Object.defineProperty(WebsocketEvent.prototype, "eventData", {
        get: $util.oneOfGetter(
          ($oneOfFields = ["pilotAdd", "pilotAlter", "pilotDelete"]),
        ),
       ...
       * @returns {$protobuf.Writer} Writer
       */
      WebsocketEvent.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        ...
        if (
          message.pilotAdd != null &&
          Object.hasOwnProperty.call(message, "pilotAdd")
        )
          $root.pulsarity.ws.PilotAddData.encode(
            message.pilotAdd,
            writer.uint32(/* id 16, wireType 2 =*/ 130).fork(),
          ).ldelim();
        if (
          message.pilotAlter != null &&
          Object.hasOwnProperty.call(message, "pilotAlter")
        )
          $root.pulsarity.ws.PilotAlterData.encode(
            message.pilotAlter,
            writer.uint32(/* id 17, wireType 2 =*/ 138).fork(),
          ).ldelim();
        if (
          message.pilotDelete != null &&
          Object.hasOwnProperty.call(message, "pilotDelete")
        )
          $root.pulsarity.ws.PilotDeleteData.encode(
            message.pilotDelete,
       ...
       * @returns {$protobuf.Writer} Writer
       */
      WebsocketEvent.encodeDelimited = function encodeDelimited(
        message,
        writer,
      ) {
        return this.encode(message, writer).ldelim();
       ...
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      WebsocketEvent.decode = function decode(
        reader,
        length,
        _end,
        _depth,
        ...
        if (_depth > $Reader.recursionLimit) throw Error("max depth exceeded");
        let end = length === undefined ? reader.len : reader.pos + length,
          message = _target || new $root.pulsarity.ws.WebsocketEvent(),
          value;
        while (reader.pos < end) {
          let start = reader.pos;
          let tag = reader.tag();
          ...
          switch ((tag >>>= 3)) {
            case 1: {
              if (wireType !== 2) break;
              if ((value = reader.bytes()).length) message.uuid = value;
              else delete message.uuid;
              continue;
            }
            case 2: {
              if (wireType !== 0) break;
              if ((value = reader.int32())) message.eventId = value;
              else delete message.eventId;
              continue;
            }
            case 16: {
              if (wireType !== 2) break;
              message.pilotAdd = $root.pulsarity.ws.PilotAddData.decode(
                reader,
                reader.uint32(),
                undefined,
                _depth + 1,
            ...
            case 17: {
              if (wireType !== 2) break;
              message.pilotAlter = $root.pulsarity.ws.PilotAlterData.decode(
                reader,
                reader.uint32(),
                undefined,
                _depth + 1,
            ...
            case 18: {
              if (wireType !== 2) break;
              message.pilotDelete = $root.pulsarity.ws.PilotDeleteData.decode(
                reader,
                reader.uint32(),
                undefined,
                _depth + 1,
      ...
      WebsocketEvent.verify = function verify(message, _depth) {
        ...
        if (message.uuid != null && message.hasOwnProperty("uuid"))
          if (
            !(
              (message.uuid && typeof message.uuid.length === "number") ||
              $util.isString(message.uuid)
            )
          )
        ...
        if (message.pilotAdd != null && message.hasOwnProperty("pilotAdd")) {
          ...
          {
            let error = $root.pulsarity.ws.PilotAddData.verify(
              message.pilotAdd,
              _depth + 1,
            );
            if (error) return "pilotAdd." + error;
          }
        }
        if (
          message.pilotAlter != null &&
          message.hasOwnProperty("pilotAlter")
        ) {
          if (properties.eventData === 1) return "eventData: multiple values";
          properties.eventData = 1;
          {
            let error = $root.pulsarity.ws.PilotAlterData.verify(
              message.pilotAlter,
              _depth + 1,
            );
            if (error) return "pilotAlter." + error;
          }
        }
        if (
          message.pilotDelete != null &&
          message.hasOwnProperty("pilotDelete")
        ) {
          if (properties.eventData === 1) return "eventData: multiple values";
          properties.eventData = 1;
          {
            let error = $root.pulsarity.ws.PilotDeleteData.verify(
              message.pilotDelete,
              _depth + 1,
            );
            if (error) return "pilotDelete." + error;
          }
        }
        return null;
      };
      ...
      WebsocketEvent.fromObject = function fromObject(object, _depth) {
        if (object instanceof $root.pulsarity.ws.WebsocketEvent) return object;
        if (_depth === undefined) _depth = 0;
        if (_depth > $util.recursionLimit) throw Error("max depth exceeded");
        ...
        if (object.uuid != null)
          if (object.uuid.length)
            if (typeof object.uuid === "string")
              $util.base64.decode(
                object.uuid,
                (message.uuid = $util.newBuffer(
                  $util.base64.length(object.uuid),
                )),
                0,
              );
        ...
        if (
          ...
          (typeof object.eventId !== "string" ||
            $root.pulsarity.ws.EventID[object.eventId] !== 0)
        )
        ...
        if (object.pilotAdd != null) {
          if (typeof object.pilotAdd !== "object")
            throw TypeError(
              ".pulsarity.ws.WebsocketEvent.pilotAdd: object expected",
            );
          message.pilotAdd = $root.pulsarity.ws.PilotAddData.fromObject(
            object.pilotAdd,
            _depth + 1,
          );
        }
        if (object.pilotAlter != null) {
          if (typeof object.pilotAlter !== "object")
            throw TypeError(
              ".pulsarity.ws.WebsocketEvent.pilotAlter: object expected",
            );
          message.pilotAlter = $root.pulsarity.ws.PilotAlterData.fromObject(
            object.pilotAlter,
            _depth + 1,
          );
        }
        if (object.pilotDelete != null) {
          if (typeof object.pilotDelete !== "object")
            throw TypeError(
              ".pulsarity.ws.WebsocketEvent.pilotDelete: object expected",
            );
          message.pilotDelete = $root.pulsarity.ws.PilotDeleteData.fromObject(
            object.pilotDelete,
            _depth + 1,
          );
        }
       ...
       * @returns {Object.<string,*>} Plain object
       */
      WebsocketEvent.toObject = function toObject(message, options) {
        if (!options) options = {};
        let object = {};
        if (options.defaults) {
        ...
        if (message.eventId != null && message.hasOwnProperty("eventId"))
          object.eventId =
            options.enums === String
              ? $root.pulsarity.ws.EventID[message.eventId] === undefined
                ? message.eventId
                : $root.pulsarity.ws.EventID[message.eventId]
              : message.eventId;
        if (message.pilotAdd != null && message.hasOwnProperty("pilotAdd")) {
          object.pilotAdd = $root.pulsarity.ws.PilotAddData.toObject(
            message.pilotAdd,
            options,
          );
          if (options.oneofs) object.eventData = "pilotAdd";
        }
        if (
          message.pilotAlter != null &&
          message.hasOwnProperty("pilotAlter")
        ) {
          object.pilotAlter = $root.pulsarity.ws.PilotAlterData.toObject(
            message.pilotAlter,
            options,
          );
          if (options.oneofs) object.eventData = "pilotAlter";
        }
        if (
          message.pilotDelete != null &&
          message.hasOwnProperty("pilotDelete")
        ) {
          object.pilotDelete = $root.pulsarity.ws.PilotDeleteData.toObject(
            message.pilotDelete,
            options,
          );
          if (options.oneofs) object.eventData = "pilotDelete";
        }
        return object;
      };
...
export const google = ($root.google = (() => {
  ...
  google.protobuf = (function () {
    ...
    protobuf.Timestamp = (function () {
       ...
       * @throws {$protobuf.util.ProtocolError} If required fields are missing
       */
      Timestamp.decode = function decode(
        reader,
        length,
        _end,
        _depth,
        ...
        while (reader.pos < end) {
          ...
          switch ((tag >>>= 3)) {
            case 1: {
              if (wireType !== 0) break;
              if (
                typeof (value = reader.int64()) === "object"
                  ? value.low || value.high
                  : value !== 0
              )
                message.seconds = value;
              else delete message.seconds;
              continue;
            }
            case 2: {
              if (wireType !== 0) break;
              if ((value = reader.int32())) message.nanos = value;
              else delete message.nanos;
              continue;
            }
          }
          reader.skipType(wireType, _depth, tag);
      ...
      Timestamp.fromObject = function fromObject(object, _depth) {
        ...
        if (object.seconds != null)
          if (
            typeof object.seconds === "object"
              ? object.seconds.low || object.seconds.high
              : Number(object.seconds) !== 0
          )
            if ($util.Long)
        ...
        if (object.nanos != null)
          if (Number(object.nanos) !== 0) message.nanos = object.nanos | 0;
        return message;
      };
