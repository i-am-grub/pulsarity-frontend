...
<template>
	<header>
		<div class="title">
			<span class="system-title">{{ eventHostName }}</span> : <span class="event-title"> {{ eventName }}</span>
		</div>
		<nav>
			<ul>
  ...
  <main>
  	...
  	<div class="event-host-info">
  		...
  		<div class="timer-info">
  			<p>One of the oldest continuously running FPV racing communities, since 2015. Offering outdoor racing through summer and indoor racing year round.</p>
  			<ul>
  				<li><a href="https://www.multigp.com/chapters/view/?chapter=Multirotor-Vermont---">MultiGP</a></li>
  				<li><a href="https://fpvscores.com/organisation/mrvt">FPVScores</a></li>
  			</ul>
  		</div>
  	</div>
  </main>
  <dialog id="system-dialog" popover>
  	<button popovertarget="system-dialog" popovertargetaction="hide"><span class="screen-reader-text">Close</span></button>
		<SystemMenuView />
  </dialog>
</template>
